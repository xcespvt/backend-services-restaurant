...
import mainBranchService from "../../services/restaurant/mainBranchService.ts";

const mainBranchController = {
  getMainBranches: async (request: FastifyRequest | any, reply: FastifyReply) => {
    try {
  ...
  toggleBranchOnlineStatus: async (request: FastifyRequest | any, reply: FastifyReply) => {
    try {
  ...
  toggleBranchRushHourStatus: async (request: FastifyRequest | any, reply: FastifyReply) => {
    try {
      const { branchId } = request.params as any;
      const user = request.user;
  ...
  upsertProfile: async (request: FastifyRequest | any, reply: FastifyReply) => {
    try {
      const { branchId } = request.params as any;
      const user = request.user;
  ...
  upsertFloor: async (request: FastifyRequest | any, reply: FastifyReply) => {
    try {
      const { branchId } = request.params as any;
  ...
  deleteFloor: async (request: FastifyRequest | any, reply: FastifyReply) => {
    try {
      const { branchId, floorId } = request.params as any;
      const user = request.user;
