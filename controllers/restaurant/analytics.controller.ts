...
import analyticsService from "../../services/restaurant/analyticsService.ts";

const analyticsController = {
  getOrderAnalytics: async (req: any, res: any) => {
    try {
  ...
  getCustomerAnalytics: async (req: any, res: any) => {
    try {
      const { branchId } = req.params;
      const { period } = req.query;
  ...
  getFeedbackAnalytics: async (req: any, res: any) => {
    try {
      const { branchId } = req.params;
      const { period } = req.query;
