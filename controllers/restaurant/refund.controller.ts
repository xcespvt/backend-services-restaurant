...
import refundService from "../../services/restaurant/refundService.ts";

const refundController = {
  getAllRefunds: async (req: any, res: any) => {
    try {
  ...
  getRefundDetails: async (req: any, res: any) => {
    try {
  ...
  createRefundRequest: async (req: any, res: any) => {
    try {
      const { branchId } = req.params;
  ...
  updateRefundStatus: async (req: any, res: any) => {
    try {
      const { branchId, refundId } = req.params;
  ...
  updateCostSplit: async (req: any, res: any) => {
    try {
      const { branchId, refundId } = req.params;
